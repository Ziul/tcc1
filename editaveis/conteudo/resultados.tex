...
Todavia, podemos observar um aumento acentuado no tempo necessário para a realização da busca do algoritmo de \textit{Smith-Waterman}, este se manteve pouco acima da média de tempo anterior, subindo da média de $27.39$ segundos da \autoref{tab:comparacao} para  $35.688$ segundos na \autoref{tab:comparacao2}, implicando em um aumento de quase $70\%$ do tempo.